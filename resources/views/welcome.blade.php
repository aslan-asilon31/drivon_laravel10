...
<body>
        ...
        <div class="position-relative px-lg-5" style="z-index: 9;">
            <nav class="navbar navbar-expand-lg bg-secondary navbar-dark py-3 py-lg-0 pl-3 pl-lg-5">
                <a href="" class="navbar-brand">
                    <h1 class="text-uppercase text-primary mb-1">Drivon</h1>
                </a>
    ...
    <div class="container-fluid bg-white pt-3 px-lg-5">
        <form action="{{ route('search.all') }}" method="GET" class="row mx-n2">
            <div class="">
                <select class="custom-select px-4 mb-3" name="pickup_location" style="height: 50px;">
                    <option selected>Pickup Location</option>
                    @foreach ($vehicles->unique('pickup_location') as $vehicle)
                    <option value="{{ $vehicle->pickup_location  }}">{{ $vehicle->pickup_location  }}</option>
                    @endforeach
                </select>
            </div>
            <div class="">
                <select class="custom-select px-4 mb-3" style="height: 50px; width:170px;">
                    <option selected>Drop Location</option>
                    @foreach ($vehicles->unique('drop_location') as $vehicle)
                    <option value="{{ $vehicle->drop_location  }}">{{ $vehicle->drop_location  }}</option>
                    @endforeach
                </select>
            </div>
            <div class="">
    ...
    <div class="container d-flex" style="">
        <div class="row col-lg-12 justify-content-center" >
            <img src="{{ asset('assets/frontend/img/about.png') }}" alt="" srcset="" style="height:420px;width:100%;">
        </div>
    </div>
    <!-- Carousel End -->
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            ...
            <h1 class="display-4 text-uppercase text-center mb-5">Welcome To <span class="text-primary">Drivon</span></h1>
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            ...
            <form action="/vehicles-search-car">
                <button class="search-car">Search</button>
            ...
            @foreach ($cars as $car)
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                        <img class="img-fluid mb-4" src="{{ Storage::url('public/vehicles/').$car->image }}" alt="">
                        ...
                        <a class="btn btn-primary px-3" href="">Rp 700.000/Day</a>
                    </div>
                </div>
            @endforeach    
            </div>
    ...
    <!-- Rent A Motorcycle Start -->
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            <h1 class="display-1 text-primary text-center">04</h1>
            <h1 class="display-4 text-uppercase text-center mb-5">Find Your MotorCycle</h1>
            <div class="row">
            @foreach ($motorcycles as $motorcycle)
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                        <img class="img-fluid mb-4" src="{{ Storage::url('public/vehicles/').$motorcycle->image }}" alt="">
                        <h4 class="text-uppercase mb-4">{{ $motorcycle->name }}</h4>
                        <div class="d-flex justify-content-center mb-4">
                            <div class="px-2">
                                <i class="fa fa-car text-primary mr-1"></i>
                                <span>2015</span>
            ...
            <div class="row mx-0">
                <div class="col-lg-6 px-0">
                    <div class="px-5 bg-secondary d-flex align-items-center justify-content-between" style="height: 350px;">
                        <img class="img-fluid flex-shrink-0 ml-n5 w-50 mr-4" src="{{ asset('asset/frontend/img/banner-left.png') }}" alt="">
        ...
        <div class="container py-5">
            ...
            <div class="owl-carousel testimonial-carousel">
                <div class="testimonial-item d-flex flex-column justify-content-center px-4">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <img class="img-fluid ml-n4" src="{{ asset('assets/frontend/') }}img/testimonial-1.jpg" alt="">
                ...
                <div class="testimonial-item d-flex flex-column justify-content-center px-4">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <img class="img-fluid ml-n4" src="{{ asset('assets/frontend/img/testimonial-2.jpg') }}" alt="">
                        <h1 class="display-2 text-white m-0 fa fa-quote-right"></h1>
                    </div>
                    <h4 class="text-uppercase mb-2">Client Name</h4>
                    <i class="mb-2">Profession</i>
                ...
                <div class="testimonial-item d-flex flex-column justify-content-center px-4">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <img class="img-fluid ml-n4" src="{{ asset('assets/frontend/img/testimonial-3.jpg') }}" alt="">
                        <h1 class="display-2 text-white m-0 fa fa-quote-right"></h1>
                    </div>
                    <h4 class="text-uppercase mb-2">Client Name</h4>
                    <i class="mb-2">Profession</i>
                ...
                <div class="testimonial-item d-flex flex-column justify-content-center px-4">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <img class="img-fluid ml-n4" src="{{ asset('assets/frontend/img/testimonial-4.jpg') }}" alt="">
                        <h1 class="display-2 text-white m-0 fa fa-quote-right"></h1>
                    </div>
                    <h4 class="text-uppercase mb-2">Client Name</h4>
                    <i class="mb-2">Profession</i>
    ...
    <div class="container-fluid bg-dark py-4 px-sm-3 px-md-5">
        <p class="mb-2 text-center text-body">&copy; Aslan</p>
		
		<!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->					
        <p class="m-0 text-center text-body">Aslan</p>
    </div>
    <!-- Footer End -->
